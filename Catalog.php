...
<html lang="en" dir="ltr">
  ...
  <body>
    <div class="container">
      ...
      <i class="fas fa-shopping-basket" id="checkout"></i>
    ...
    <div class="set">
      <div class="set1">
        <div class="page">
          <a href="http://localhost/tasks/priv/product.php"><img src="img/apple1.jpg"></a>
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p >256GB Gold</p>
          <h2 class="item_price">610990 Tg</h2>
        ...
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price">540990 Tg</h2>
        </div>
        <div class="page">
          <img src="img/apple3.jpg">
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price">120990 Tg</h2>
          <a href="#"><img width="30px" class="icon4" src="https://image.flaticon.com/icons/png/512/2/2772.png"/></a>
      ...
      <div class="set2">
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price">560990 Tg</h2>
        ...
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price">760990 Tg</h2>
        ...
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price">110990 Tg</h2>
      ...
      <div class="set3">
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price">643990 Tg</h2>
        ...
        <div class="page">
          ...
          <p class="item_title">Smartphone Apple Iphone XS Max</p>
          <p>256GB Gold</p>
          <h2 class="item_price">310990 Tg</h2>
...
<div id="cart_content"></div>
  ...
  <script >
    var d = document,
    itemBox = d.querySelectorAll('.set'), // блок каждого товара
